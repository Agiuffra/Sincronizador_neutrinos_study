...
HD_PWD='C:/Users/agiuffra/Documents/Neutrino_VHDL/Time_Stamp_Controller/Time_Stamp_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FT_CNTR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FT_CNTR.tcl -notrace
